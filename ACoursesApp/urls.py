...
from ACoursesApp.views import ACoursesCourseDetailAPIView, ACoursesPurchaseListAPIView, ACoursesLessonDetailAPIView, \
    ...
    ACoursesLessonResultDetailAPIView, ACoursesPurchaseAddAPIView
...
urlpatterns = [
    ...
    path('<int:courseID>/purchase<int:pk>', ACoursesPurchaseAddAPIView.as_view()),
    ...
    path('/result<int:pk>',
         ACoursesLessonResultDetailAPIView.as_view()),
