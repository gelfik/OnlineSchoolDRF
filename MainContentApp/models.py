...
# from CoursesApp.models import CoursesTypeModel, CoursesPredmetModel
#
# class EducationList(models.Model):
#     # name = models.CharField('Название', default=None, max_length=255)
#     course = models.ForeignKey(CoursesTypeModel, on_delete=models.CASCADE, verbose_name='Название курса', default=None,
#                                null=True)
